...
struct cell_config {
	/* Cell policy profile. */
	enum cell_policy_profile jc_profile;
};
...
int secmodel_cell_create(const struct cell_create *,
    const struct cell_config *, cellid_t *);
int secmodel_cell_destroy(cellid_t);
int secmodel_cell_enter(struct lwp *, cellid_t);

int secmodel_cell_system_cb(kauth_cred_t, kauth_action_t, void *,
    void *, void *, void *, void *);
int secmodel_cell_network_cb(kauth_cred_t, kauth_action_t, void *,
    void *, void *, void *, void *);
int secmodel_cell_process_cb(kauth_cred_t, kauth_action_t, void *,
    void *, void *, void *, void *);
int secmodel_cell_cred_cb(kauth_cred_t, kauth_action_t, void *,
    void *, void *, void *, void *);

...
## 11. Kernel review pointer

For kernel-level hardening/audit work, use:

- `doc/specs/cells/06-kernel-audit-checklist.md`

That checklist is the required gate for `sys/secmodel/cell/*` behavioral
changes, especially around lock ordering, lifecycle transactions, sysctl ABI,
and `cellctl` compatibility.
